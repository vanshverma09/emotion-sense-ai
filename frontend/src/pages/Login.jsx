...
export default function Login() {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // TODO: Hook up with FastAPI backend POST /api/v1/auth/login
    navigate('/dashboard'); 
  };

  return (
    <div className="flex h-screen items-center justify-center bg-background relative overflow-hidden">
      <div className="absolute -top-32 -left-32 w-[500px] h-[500px] bg-secondary/10 rounded-full blur-[100px] pointer-events-none"></div>
      ...
      >
        ...
        <p className="text-slate-400 mb-8">Sign in to Emotion Sense AI</p>
